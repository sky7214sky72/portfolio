...
public class SignController {
  ...
  public ResponseEntity<SignInResponse> loginKakao(String code) {
    return oauthService.login(OauthServerType.KAKAO, code);
  }

  @GetMapping("/oauth2/code/GOOGLE")
  public ResponseEntity<SignInResponse> loginGoogle(String code) {
    return oauthService.login(OauthServerType.GOOGLE, code);
  }

  @GetMapping("/oauth2/code/NAVER")
  public ResponseEntity<SignInResponse> loginNaver(String code) {
    return oauthService.login(OauthServerType.NAVER, code);
  }
}
